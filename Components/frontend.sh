...
#for comp in catalogue user; do 
    sed -i -e '/catalogue/s/localhost/172.31.17.159/' -e '/user/s/localhost/172.31.80.123/' -e '/cart/s/localhost/172.31.20.102/' /etc/nginx/default.d/roboshop.conf  >> /tmp/frontend
    Status $?
#done
